(function (skuid) {
	...
	bc.registerBuilder(new bc.Builder({
		...
		propertiesRenderer: function (propViewer, component) {
			propViewer.setTitle('Pivot Table Properties');
			...
			var basicPropsList = [
				{
					...
					required: true,
					onChange: function() {
						state.removeAttr("rowField columnField valueField");
			...
			propViewer.applyPropsWithCategories(
				[
					{
						name: 'Basic',
		...
		defaultStateGenerator: function () {
			return skuid.utils.makeXMLDoc('<pivot__pivottable />');
		}
